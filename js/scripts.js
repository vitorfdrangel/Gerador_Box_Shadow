class BoxShadowGenerator {
  ...
  applyRule() {
    ...
    this.currentRules = shadowRule;
  }

  showRules() {
    this.rule.innerText = this.currentRules;
    this.webkitRule.innerText = this.currentRules;
    this.mozRule.innerText = this.currentRules;
  }
